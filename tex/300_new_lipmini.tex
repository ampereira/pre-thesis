...
\itodo{abstrai user de que nao programa para os eventos todos mas apenas para um}
\itodo{paralelizaçao em processos e threads e heterogeneous, eficiencia é diferente de performance...}
\itodo{levantamento de requisitos}
\itodo{features devem depender pouco de libs para correrem em accelerators}
